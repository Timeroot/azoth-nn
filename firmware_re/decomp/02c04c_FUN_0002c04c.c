...
void FUN_0002c04c(uint param_1,uint param_2,undefined1 *param_3)

{
  ...
  if (param_3 < (undefined1 *)0xbd) {
    param_3 = (undefined1 *)(uint)(byte)param_3[DAT_0002c0f0];
  }
  else if ((undefined1 *)0x1e < param_3 + -0x1e0) {
    if (param_3 == (undefined1 *)0xd3) {
      param_3 = &LAB_0000a0d2_1;
    }
    else if (param_3 == (undefined1 *)0xff) {
      iVar4 = DAT_0002c0f8 + param_1 * 8;
      if (uVar3 == 0xd4) {
        param_3 = (undefined1 *)(uint)*(ushort *)(iVar4 + 4);
      }
      else if (uVar3 == 0xd5) {
        param_3 = (undefined1 *)(uint)*(ushort *)(iVar4 + 2);
      }
      else if (uVar3 == 0xd6) {
        param_3 = (undefined1 *)(uint)*(ushort *)(iVar4 + 6);
      }
    }
    else {
